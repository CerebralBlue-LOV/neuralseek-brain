...
| What is NeuralWorks? How does it differ from Gong / Fireflies / Otter / Zoom AI / Microsoft Copilot? | [`Features/neuralworks-ai-notetaker.md`](https://raw.githubusercontent.com/CerebralBlue-LOV/neuralseek-brain/main/NeuralSeek%20Knowledge/Features/neuralworks-ai-notetaker.md) — NeuralSeek's governed AI notetaker for Teams/Zoom/Meet. Runs inside your boundary (on-prem / VPC / air-gapped), LLM-agnostic, semantic-lineage summary scoring, 4-layer PII/PHI redaction, full replay audit, 8 ship-ready agents (CRM update, Slack action items, Jira tickets, summary emails). *"A notetaker your CISO approves."* |
...
| Which logo/image file do I use for a given app, data source, LLM, customer, or compliance framework? | [`2026_images/IMAGE_MAP.md`](https://raw.githubusercontent.com/CerebralBlue-LOV/neuralseek-brain/main/2026_images/IMAGE_MAP.md) — canonical image-library map (folder guide + file→name→use tables for every logo and icon) |
